...
class TestInitApp:
    ...
    def test_overwrites_existing(self) -> None:
        ...
        im1, md1, ocr1, emb1 = (MagicMock() for _ in range(4))
        im2, md2, ocr2, emb2 = (MagicMock() for _ in range(4))
        app_state.init_app(im1, md1, ocr1, emb1)
        app_state.init_app(im2, md2, ocr2, emb2)
...
class TestGetIndexManager:
    ...
    def test_returns_instance(self) -> None:
        ...
        im = MagicMock()
        app_state.init_app(im, MagicMock(), MagicMock(), MagicMock())
...
class TestGetOcrService:
    ...
    def test_returns_instance(self) -> None:
        """初始化后应返回 OCR 服务实例。"""
        ocr = MagicMock()
        app_state.init_app(MagicMock(), MagicMock(), ocr, MagicMock())
...
class TestGetEmbeddingService:
    ...
    def test_returns_instance(self) -> None:
        ...
        emb = MagicMock()
        app_state.init_app(MagicMock(), MagicMock(), MagicMock(), emb)
...
class TestGetMetadataStore:
    ...
    def test_returns_instance(self) -> None:
        ...
        app_state.init_app(MagicMock(), md, MagicMock(), MagicMock())
